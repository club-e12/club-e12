...
<head>
    <title>Navigation with JavaScript</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#navigation li").click(function (e) {
                ...
                // 
                $("#navigation li").attr("iamhere", "false");
                $("#navigation li").attr("expand", "true");
                
                // but set iamhere true for the current selected one,               
            
                $(this).attr("iamhere", "true");  
                
                // if current <lis> was clicked again then do not expand
                if (old_iamhere)  {
                    $(this).attr("expand", "false");   
                }
                
                save_this = $(this); // yess, this works !!!
                
       /*    alert (old_iamhere)  ;         // ok , works */   
       ...
       //         alert( $(this).attr("id") +" "+ $(this).attr("iamhere") +" "+  $(this).attr("expand")  );
            
               
       /*        $(this).attr("expand", "true");  // no influence  ?!?!?
               $("#navigation li").attr("expand", "true"); // fail   */
               
        /*        $(this).attr("expand", "true"); // fail again  */
        ...
        //        alert( $(this).attr("id") +" "+ $(this).attr("iamhere") +" "+  $(this).attr("expand")  );
            ...
            // show top level of clamshell once on document ready event
            
            $('#navigation ul').hide();
    
            $('#navigation > ul > li ').parents().show(); // ! selector to remember
...
<body id="ivy_harvard">
    ...
    <div id="header">
        <h1>Navigation with JavaScript</h1></div>
