    ...
    global $group_closed;
       ...
       foreach ($para as $key => $value) {
           ...
           if ( $new_node &&   $last_depth == $depth  )  { 
                ...
                { if ( $new_node &&   $group_closed )  { 
                    print ( "<ul> OPEN GROUP " );          
                    }
                }
           
            if ( $new_node ) {
                  print ("<br/>last " . $last_depth . "  depth: ". $depth ." prev_depth: ".$prev_node_depth  ."<br/>");
               ...
               if ($key=="path")  {
                    print (   " " . $value .  "<i> depth: ". $depth ." prev_depth: ".$prev_node_depth . " temp:".$temp."</i> </li> ");
                    }
